...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Queue was not removing people correctly
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Bob was given an extra turn
    ...
    // Defect(s) Found: Check for infinite turn players and enqueue them again
